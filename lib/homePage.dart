        ...
        child: ListView(
          children: [
            ...
            LeftWidget(
                ...
                mainText:
                    'Process traditional bank transfers from your clients instantly.\nBy analyzing bank statements PayR tells you how much each of your clients paid in current billing period so you can save your precious time you\'d spend otherwise on doing it by hand.',
                img: 'assets/eGalileo/imac@2x.png',
                stack: 'js, nodejs'),
          ],
        ),
